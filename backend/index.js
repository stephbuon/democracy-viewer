...
// Increase server timeout for large uploads (12 hours)
app.use((req, res, next) => {
    req.setTimeout(43200000);
    res.setTimeout(43200000);
    next();
});
...
server.timeout = 43200000; // 12 hours
server.keepAliveTimeout = 43200000;
